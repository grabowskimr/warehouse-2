                ...
                <Paper square={true} className={classes.paper}>
                    <div className={classes.insideContent}>
                        ...
                        <form className={classes.form} onSubmit={loginToApp}>
                            <TextField label="Login" fullWidth margin="normal" value={login}
                                       onChange={(e) => setLogin(e.target.value)}/>
                            <TextField label="Password" type="password" fullWidth margin="normal" value={password}
                                       onChange={(e) => setPassword((e.target.value))}/>
                            <Button variant="contained" color="primary" type="submit" className={classes.submitBtn}>Sign
                                In</Button>
                        </form>
                    </div>
                </Paper>
